 ...
 <head>
    ...
    <!-- site Favicon -->
    <link rel="icon" href="{{asset('web/assets/images/favicon/favicon-3.png')}}" sizes="32x32" />
    <link rel="apple-touch-icon" href="{{asset('web/assets/images/favicon/favicon-3.png')}}" />
    <meta name="msapplication-TileImage" content="{{asset('web/assets/images/favicon/favicon-3.png')}}" />
    ...
    <!-- Main Style -->
    <link rel="stylesheet" href="{{asset('web/assets/css/demo3.css')}}" />
...
<body>
                    ...
                    <div class="header-bottom-flex">
                        ...
                        <div class="align-self-center ec-header-logo ">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{asset('web/assets/images/logo/logo-3.png')}}"
                                        alt="Site Logo" /><img class="dark-logo"
                                        src="{{asset('web/assets/images/logo/dark-logo-3.png')}}" alt="Site Logo"
                            ...
                            <div class="header-search">
                                <form class="ec-search-group-form" action="#">
                                    ...
                                    <button class="search_submit" type="submit">Search <img
                                            src="{{('web/assets/images/icons/search.svg')}}" class="svg_img search_svg"
                                            alt="" /></button>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="ec-header-bottons">
                                ...
                                <div class="ec-header-user dropdown">
                                    <button class="dropdown-toggle" data-bs-toggle="dropdown"><img
                                            src="{{('web/assets/images/icons/user.svg')}}" class="svg_img header_svg"
                                ...
                                <a href="#" class="ec-header-btn ec-header-wishlist">
                                    <div class="header-icon"><img src="{{('web/assets/images/icons/wishlist.svg')}}"
                                ...
                                <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
                                    <div class="header-icon"><img src="{{('web/assets/images/icons/cart.svg')}}"
        ...
        <div class="ec-header-bottom d-lg-none">
            <div class="container position-relative">
                <div class="row ">
                    ...
                    <div class="col">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{('web/assets/images/logo/logo-3.png')}}" alt="Site Logo" /><img
                                    class="dark-logo" src="{{('web/assets/images/logo/dark-logo-3.png')}}" alt="Site Logo"
                                    style="display: none;" /></a>
                        </div>
                    </div>
                    <!-- Ec Header Logo End -->
                                        ...
                                        <li>
                                            <ul class="ec-main-banner w-100">
                                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img
                                                            ...
                                                            src="{{('web/assets/images/menu-banner/9.jpg')}}" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img
                                                            class="img-responsive"
                                                            src="{{('web/assets/images/menu-banner/10.jpg')}}" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img
                                                            class="img-responsive"
                                                            src="{{('web/assets/images/menu-banner/11.jpg')}}" alt=""></a>
                                                </li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img
                                                            class="img-responsive"
                                                            src="{{('web/assets/images/menu-banner/12.jpg')}}" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                        ...
                        <li><a href="javascript:void(0)">Categories</a>
                            <ul class="sub-menu">
                                ...
                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive"
                                            src="{{('web/assets/images/menu-banner/1.jpg')}}" alt=""></a>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{('web/assets/images/product-image/19_1.jpg')}}" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{('web/assets/images/product-image/20_1.jpg')}}" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="{{('web/assets/images/product-image/21_1.jpg')}}" alt="product"></a>
                        <div class="ec-pro-content">
    ...
    <div class="ec-main-slider section section-space-mb">
        <div class="ec-slider">
            <div class="ec-slide-item d-flex slide-1">
                <img src="{{('web/assets/images/main-slider-banner/arrow-7.png')}}" class="main_banner_arrow_img" alt="" />
            ...
            <div class="ec-slide-item d-flex slide-2">
                <img src="{{('web/assets/images/main-slider-banner/arrow-8.png')}}" class="main_banner_arrow_img" alt="" />
                <div class="container align-self-center">
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center">
                            <div class="ec-slide-content slider-animation">
            ...
            <div class="ec-slide-item d-flex slide-3">
                <img src="{{('web/assets/images/main-slider-banner/arrow-9.png')}}" class="main_banner_arrow_img" alt="" />
                <div class="container align-self-center">
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center">
                            <div class="ec-slide-content slider-animation">
            ...
            <div class="row">
                <div class="ec_cat_slider">
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <div class="ec-cat-image">
                                <img src="{{('web/assets/images/category-image/1.jpg')}}" alt="" />
                            </div>
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <div class="ec-cat-image">
                                <img src="{{('web/assets/images/category-image/2.jpg')}}" alt="" />
                            </div>
                            <div class="ec-cat-desc">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <div class="ec-cat-image">
                                <img src="{{('web/assets/images/category-image/3.jpg')}}" alt="" />
                            </div>
                            <div class="ec-cat-desc">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <div class="ec-cat-image">
                                <img src="{{('web/assets/images/category-image/4.jpg')}}" alt="" />
                            </div>
                            <div class="ec-cat-desc">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <div class="ec-cat-image">
                                <img src="{{('web/assets/images/category-image/5.jpg')}}" alt="" />
                            </div>
                            <div class="ec-cat-desc">
                                <span class="ec-section-btn"><a href="shop-left-sidebar-col-3.html" class="btn-primary">Sofa chair</a></span>
                            </div>
        ...
        <div class="ec-banners">
            <div class="ec-banner-left col-sm-6">
                <div class="ec-banner-block ec-banner-block-1 col-sm-12">
                    <div class="banner-block">
                        <img src="{{('web/assets/images/banner/15.jpg')}}" alt="" />
            ...
            <div class="ec-banner-right col-sm-6">
                <div class="ec-banner-block ec-banner-block-2 col-sm-12">
                    <div class="banner-block">
                        <img src="{{('web/assets/images/banner/16.jpg')}}" alt="" />
                        <div class="banner-content">
                            <div class="banner-text">
                ...
                <div class="ec-banner-block ec-banner-block-3 col-sm-6">
                    <div class="banner-block">
                        <a href="#">
                            <img src="{{('web/assets/images/banner/17.jpg')}}" alt="" />
                            <div class="banner-content">
                                <div class="banner-text">
                ...
                <div class="ec-banner-block ec-banner-block-4 col-sm-6">
                    <div class="banner-block">
                        <a href="#">
                            <img src="{{('web/assets/images/banner/18.jpg')}}" alt="" />
                            <div class="banner-content">
                                <div class="banner-text">
                                                ...
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/19_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/19_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                                                                src="{{('web/assets/images/icons/cart.svg')}}"
                                                                class="svg_img pro_svg" alt="" /></button>
                                                        <a href="compare.html" class="ec-btn-group compare"
                                                            title="Compare"><img
                                                                src="{{('web/assets/images/icons/compare.svg')}}"
                                                                class="svg_img pro_svg" alt="" /></a>
                                                        <a href="#" class="ec-btn-group quickview"
                                                            data-link-action="quickview" title="Quick view"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#ec_quickview_modal"><img
                                                                src="{{('web/assets/images/icons/quickview.svg')}}"
                                                                class="svg_img pro_svg" alt="" /></a>
                                                        <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                src="{{('web/assets/images/icons/pro_wishlist.svg')}}"
                                                                class="svg_img pro_svg" alt="" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/20_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/20_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/21_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/21_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/22_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/22_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/23_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/23_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/24_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/24_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/25_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/25_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/26_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/26_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="flags">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/27_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/27_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{('web/assets/images/product-image/28_1.jpg')}}"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="{{('web/assets/images/product-image/28_2.jpg')}}"
                                                            alt="Product" />
                                                    </a>
                                                    <div class="ec-pro-actions">
                                                        <button title="Add To Cart" class=" add-to-cart"><img
    ...
    <section class="section ec-offer-section section-space-mt section-space-mb">
        ...
        <!-- <img src="{{('web/assets/images/offer-image/offer_bg.jpg')}}" alt="" class="offer_bg" /> -->
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row mb-minus-30">
                <div class="ec_ser_content ec_ser_content_1 col-sm-12 col-md-4">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="{{('web/assets/images/icons/service_1.svg')}}" class="svg_img" alt="" />
                        </div>
                ...
                <div class="ec_ser_content ec_ser_content_2 col-sm-12 col-md-4">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="{{('web/assets/images/icons/service_3.svg')}}" class="svg_img" alt="" />
                        </div>
                        <div class="ec-service-desc">
                            <h2>Free Returns</h2>
                            <p>We provide 3 Day Return or Replacement Policy</p>
                        </div>
                    </div>
                </div>
                <div class="ec_ser_content ec_ser_content_3 col-sm-12 col-md-4">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="{{('web/assets/images/icons/service_2.svg')}}" class="svg_img" alt="" />
                        </div>
                        <div class="ec-service-desc">
            ...
            <div class="row">
                <div class="col-md-12 section-title-block">
                    <div class="section-title">
                        ...
                        <p class="sub-title">What our customers say about us!</p>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <li class="ec-test-item">
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{('web/assets/images/testimonial/1.jpg')}}" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-icon"><img src="{{('web/assets/images/testimonial/quote-3.svg')}}"
                        ...
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img
                                            src="{{('web/assets/images/logo/footer-logo-3.png')}}" alt=""><img
                                            class="dark-footer-logo" src="{{('web/assets/images/logo/dark-logo-3.png')}}"
    ...
    <script src="{{asset('web/assets/js/demo-3.js')}}"></script>
