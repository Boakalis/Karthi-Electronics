                ...
                <div class="profile-content-right profile-right-spacing py-5">
                    <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myProfileTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{$tab == 2 ? 'active' : ''}}" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" wire:click="tabChange(1)" aria-selected="true">Profile</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{$tab == 1 ? 'active' : ''}}" id="settings-tab" data-bs-toggle="tab" data-bs-target="#settings" type="button" role="tab" aria-controls="settings" wire:click="tabChange(2)" aria-selected="false">Settings</button>
                        </li>
                    </ul>
                    <div class="tab-content px-3 px-xl-5" id="myTabContent">

                        <div class="tab-pane fade {{$tab == 2 ? 'active show' : ''}} " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="tab-pane fade {{$tab == 1 ? 'active show' : ''}} " id="settings" role="tabpanel" aria-labelledby="settings-tab">
                            <div class="tab-pane-content mt-5">
                                <form wire:click.prevent.submit="save">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" wire:model="storeName" id="storeName" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="password" class="form-control" id="newPassword" wire:model="password">
                                    </div>

                                    <div class="form-group mb-4">
                                        <label for="conPassword">Confirm password</label>
                                        <input type="password" wire:model="confirmPassword" class="form-control" id="conPassword">
                                    </div>
