<div >
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        <div>
            ...
            <p class="breadcrumbs"><span><a href="{{route('dashboard')}}">Home</a></span>
                <span><i class="mdi mdi-chevron-right"></i></span>District
            </p>
        </div>
        <div>
            <a href="javascript:void(0)" data-bs-toggle="modal"
            data-bs-target="#districtModal" wire:click="$emit('resetData')" class="btn btn-primary">Add</a>
        </div>
    </div>
    ...
    <div wire:ignore.self class="modal fade" id="districtModal" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-12">
                            <div class="contact-info px-4">
                                <h4 class="text-dark mb-1 text-center mb-3" id="title" >Add District</h4>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"  name="name" id="name" placeholder="Enter District Name" wire:model="name"   >
                                                    @if ($errors->has('name'))
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" wire:model="state"  wire:click="changeState($event.target.value)" id="">
    ...
    <div wire:ignore.self class="modal fade" id="districtEditModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-end border-bottom-0">
                ...
                <div class="modal-body pt-0">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-12">
                            <div class="contact-info px-4">
                                <h4 class="text-dark mb-1 text-center mb-3" id="title" >Edit District</h4>
                                <form method="POST" wire:click.prevent.submit  enctype="multipart/form-data" >
                                    @csrf
                                        <div class="row mb-2">
                                            <div class="col-lg-6">
