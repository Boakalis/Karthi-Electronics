                            ...
                            <div class="row">
                                @if (isset($datas) && $datas->count() >0 )
                                    @foreach ($datas as $data)
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6 pro-gl-content">
                                            <div class="ec-product-inner">
                                                ...
                                                <div class="ec-pro-content">
                                                    <h5 class="ec-pro-title text-center"><a href="{{route('web.product.detail',['category' => $data->subcategory->category->slug ,'product' =>$data->subcategory->slug ,'slug' => $data->slug])}}">{{$data->name}}</a></h5>
