                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8 row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="name" required placeholder="Enter Product Name" class="form-control" disabled value="{{@$data->name}}" id="name" />
                                            {{-- @if ($errors->has('name'))
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <select name="dealer_id" disabled id="select2Modal"  class=" form-control ">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select name="subcategory_id" disabled required id="categories" class="form-select">
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input disabled  type="checkbox" onclick="variantEvent(event)" name="is_products_variant" id="productVariant"  {{$data->is_products_variant == 1 ? 'checked' : ''}} value="{{$data->is_products_variant == 1 ? '1' : '0'}}" />
                                                <label></label>
                                            </div>
                                        </div>
                                            ...
                                            <div id="repeater">
                                                ...
                                                <div class="repeater-heading col-12">
                                                    <label class="form-label">
                                                        Variants
                                                        {{-- <button type="button" disabled class="btn btn-primary btn-sm float-right repeater-add-btn">
                                                            Add
                                                        </button> --}}
                                                    </label>
                                                </div>
                                                    ...
                                                    <div class="item" id="variant{{$variant->id}}">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="col-12">
                                                                    <input id="variant" disabled value="{{$variant->name}}" name="variants_old[{{$key}}][name]" class="form-control"  type="text" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label for="dp" class="col-12 col-form-label">Dealer Price<span>(In &#8377; )</span></label>
                                                                <div class="col-12">
                                                                    <input id="dp" disabled  value="{{$variant->dealer_price}}"
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="col-12">
                                                                    <select disabled name="variants_old[{{$key}}][status]" id="" class=" form-control ">
                                                    ...
                                                    <div class="item-content">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label for="variant" class="col-12 col-form-label">Varaint Name <span>(In &#8377; )</span></label>
                                                                <div class="col-12">
                                                                    <input id="variant" disabled data-name="variant_name" class="form-control"  type="text" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label for="dp" class="col-12 col-form-label">Dealer Price<span>(In &#8377; )</span></label>
                                                                <div class="col-12">
                                                                    <input id="dp" disabled  data-name="dealer_prices" class="form-control"  type="number" />
                                                                </div>
                                                            </div>
                                                            @if (AUth::user()->user_type ==1)
                                                            <div class="col-md-3">
                                                                <label for="sp" class="col-12 col-form-label">Seller Price<span>(In &#8377; )</span></label>
                                                                <div class="col-12">
                                                                    <input id="sp" disabled data-name="sale_prices" class="form-control"  type="number" />
                                                                </div>
                                                            </div>
                                                            @endif
                                                            <div class="col-md-3">
                                                                <label for="sp" class="col-12 col-form-label">Status</label>
                                                                <div class="col-12">
                                                                    <select data-name="status" disabled id="" class=" form-control ">
                                        ...
                                        <div class="col-4 mb-25 mt-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="color" name="colors[]" disabled value="{{$color[0]}}"  class="form-control form-control-color" id="exampleColorInput1" title="Choose your color" />
                                                <input type="color" name="colors[]" disabled value="{{$color[1]}}" class="form-control form-control-color" id="exampleColorInput2" title="Choose your color" />
                                                <input type="color" name="colors[]" class="form-control  form-control-color" id="exampleColorInput3" disabled value="{{$color[2]}}" title="Choose your color" />
                                                <input type="color" name="colors[]" disabled value="{{$color[3]}}" class="form-control form-control-color" id="exampleColorInput4" title="Choose your color" />
                                            </div>
                                        </div>
                                        @if (Auth::user()->user_type ==1)
                                        <div class="col-8 form mb-25 mt-1">
                                            ...
                                            <div class="form-checkbox-box">
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" disabled  name="is_featured" {{$data->is_featured == 1 ? 'checked' : ''}} value="1" />
                                                    <label>Featured</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" disabled  {{$data->is_exclusive == 1 ? 'checked' : ''}} name="is_exclusive" value="1" />
                                                    <label>Exclusive</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" disabled name="is_trending" {{$data->is_trending == 1 ? 'checked' : ''}} value="1" />
                                                    <label>Trending</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" disabled {{$data->is_best_sellers == 1 ? 'checked' : ''}} name="is_best_sellers" value="1" />
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" disabled id="meta_title" name="meta_title" value="{{@$data->meta_title}}" placeholder="Enter Meta Title" />
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Meta Description</label>
                                            <input type="text" class="form-control" disabled id="meta_description" name="meta_description" value="{{@$data->meta_decription}}" placeholder="Enter Meta Description" />
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Meta Keywords</label>
                                            <input type="text" class="form-control" disabled id="keywords" name="keywords" value="{{@$data->keywords}}" placeholder="Enter Meta Keywords" />
                                        </div>
                                        @endif
                                        @if ($data->status != 2)
                                        <div class="col-md-6">
