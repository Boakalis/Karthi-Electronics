...
class Home extends Component
{
    public function render()
    {
        ...
        $products = Product::with('subcategory','subcategory.category')->orderBy('id','DESC')->take(18)->get();
        ...
        $featuredProduct = Product::where([['status',1],['is_featured',1]])->orderBy('id','DESC')->take(16)->get();
        $exclusiveProduct = Product::where([['status',1],['is_exclusive',1]])->orderBy('id','DESC')->take(16)->get();
        $trendingProduct = Product::where([['status',1],['is_trending',1]])->orderBy('id','DESC')->take(16)->get();
        $bestProduct = Product::where([['status',1],['is_best_sellers',1]])->orderBy('id','DESC')->take(16)->get();
